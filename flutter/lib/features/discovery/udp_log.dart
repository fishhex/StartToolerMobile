...
//   - 用 print() 而非 debugPrint/developer.log —— 后两者在某些 Android 版本
//     + HyperOS 环境下被 SELinux/ring buffer 过滤；print 走 logcat 的
//     'flutter' tag，稳定可见。
//   - 不破坏现有 API：仅提供静态方法。
...
class UdpLog {
  ...
  static void emit(String tag, String message) {
    ...
    // ignore: avoid_print
    print('[$tag][#${n.toString().padLeft(4, '0')} t=$ms] $message');
  }
